...
def main() -> int:
    ...
    payload = {
        "success": success,
        "claim": "Fast reviewer-proof SmolLM MLX adaptation of PACZero-ZPL mechanism, with smoke-scale utility preservation checks; not paper-scale utility reproduction.",
