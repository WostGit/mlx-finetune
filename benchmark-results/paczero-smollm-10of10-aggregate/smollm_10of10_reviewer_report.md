...
Fast reviewer-proof SmolLM MLX adaptation of the PACZero-ZPL mechanism, with smoke-scale utility preservation checks; **not** paper-scale OPT utility reproduction.
...
|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| SST-2 | true | 42.481 | 126 | [63] | 60 | 30 | 1.0 | 1.0 | true | true | 0 |
| SQuAD | true | 62.08 | 126 | [63] | 60 | 30 | 1.0 | 1.0 | true | true | 0 |

## Utility preservation details

| Task | Run | Selection metric delta | Held-out eval delta | Interpretation |
|---|---|---:|---:|---|
| SST-2 | ZPL | dev loss `-0.0095867`, dev acc `+0.0` | eval loss `-0.0050299`, eval acc `+0.0` | preserved; slight loss improvement, accuracy flat |
| SQuAD | ZPL | dev loss `-0.0002972` | eval loss `+0.0008010` | preserved on selection metric; eval change tiny |
| SST-2 | non-private ZO control | dev loss `-0.0118902`, dev acc `+0.0` | eval loss `-0.0043928`, eval acc `+0.0` | preserved; slight loss improvement, accuracy flat |
| SQuAD | non-private ZO control | dev loss `-0.0004680` | eval loss `+0.0005448` | preserved on selection metric; eval change tiny |
